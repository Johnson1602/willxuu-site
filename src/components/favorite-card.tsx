...
import { FavoriteModalHorizontal } from '@/components/favorite-modal-horizontal'
  ...
  return (
    <>
      <button
        ...
        className='group relative overflow-hidden rounded-2xl aspect-3/4 shadow-md transition-shadow duration-500 ease-out hover:shadow-xl text-left w-full cursor-pointer'
      >
        <ThemedImage
